  ...
  state() {
    return {
              ...
              parts: [
                {
                  ...
                  body: [
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "In this section, this shows that even with your disability, you are entitled to a job opportunity if you are able to get all the qualifications that the company is looking for. The government also mandated a certain number of percentages for certain organizations just for people with disabilities.",
                    },
                    {
                      type: "section",
                      text:
                        "<span class='paragraphBold'> Section 7. </span> Apprenticeship. Subject to the provisions of the Labour Code as amended, disabled persons shall be eligible as apprentices or learners: provided that their handicap is not much as to effectively impede the performance of job operations in the particular occupation for which they are hired; provided, further, that after the lapse of the period of apprenticeship if found satisfactory in the job performance, they shall be eligible for employment.",
                    },
                    {
                      type: "p-bold",
                      text: "Reflection:",
                    },
                    {
                      type: "in-line-link",
                      text:
                        "Every individual needs the proper job experience so that they may go reach their dream jobs--this includes you! An apprenticeship or internship will help cultivate and hone your skills and prepare you to a full-time job in a department that you want! If you are able to do a great performance during your internship, you may even be recruited by the company as an employee. For internship opportunities available, <a href='#'> you may click here </a>",
                    },
                    {
                      type: "img",
                    ...
                    },
                    {
                      type: "section",
                      text:
                        "<span class='paragraphBold'> Section 32. </span> Discrimination on employment. No entity, whether public or private, shall discriminate against a qualified disabled person by reason of disability in regard to job application procedures, the hiring, promotion, or discharge of employees, employee compensation, job training, and other terms, conditions, and privileges of employment. The following constitute acts of discrimination:",
                    },
                    {
                      type: "p",
                      text:
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "In summary of this section, you are entitled to equal opportunities in relation to employment. You are not to be discriminated against your disability and are not to be favored less than the other employees or applicants. Experienced any discrimination? Then fight for your rights! It is written in the law, therefore you have every right if they treated you less.",
                    },
                  ],
                },
              ],
                  ...
                  body: [
                    {
                      type: "p",
                      text:
                        "From the previous videos presented, you see stories of different persons with disabilities with inspiring stories. Because they are an advocate of themselves, they continued to persevere and move forward. Because they know their rights, please freely discuss below what insights were you able to gather and how can it be applied into your life:",
                    },
                  ],
                },
                {
                ...
                },
                {
                  ...
                  body: [
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "After submitting your activity, please proceed to contacting your self-advocacy group and your instructor regarding your thoughts and feelings. This will help you ease any anxieties or concerns you have with yourself as a working individual. ",
                    },
                  ],
                },
              ],
                ...
                },
                {
                  ...
                  body: [
                    ...
                    },
                    {
                      type: "listHeader",
                      text:
                        "If it is possible for you, you may also reach out to other individuals in the same industry or in the same position you are interested in. Ask and talk to them regarding any potential gaps in your skill set and what these industries typically look for in an employee. It is also helpful to prepare your thoughts on the following topics:",
                    },
                    {
                      type: "list",
                      text: [
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Whatever decision you make, do not be afraid to ask others who are in the same predicament as you (which is why we have our self-advocacy group to help you with your problems together). You can also do some prior research before proceeding with the interview.",
                    },
                    {
                      type: "img",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "There will be some times where some employers believe that you are less suited for your position because you are deaf. While this ableism mindset from able-bodied people and unfair misconceptions continue to plague many deaf individuals, mindsets can still be changed. ",
                    },
                    {
                      type: "p",
                      text:
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Always remember--the qualifications and experiences you have placed in your resume is what led you up to this interview. Don’t doubt yourself and be confident! Be proud of your achievements and DEAF-initely ace that interview!",
                    },
                    {
                      type: "p",
                      text:
                        "Looking for a job or an opportunity to make your resume look appealing to the employers? Check out our internship opportunities and partnered companies here! We are more than happy to help!",
                    },
                    {
                      type: "ref",
                      text:
                        "(How to Ace the Interview With a Disability, Iswari Nallisamy)",
                    },
                    {
                      type: "ref",
                      text:
                        "(How to Prepare for a Job Interview If You’re Deaf, 2020)",
                    },
                  ],
                },
                {
                  ...
                  body: [
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Before proceeding into your interview prompt, here are some questions you may answer and prepare for:",
                    },
                    {
                      type: "header",
                    ...
                    },
                    {
                      type: "header",
                      text:
                        "6. Can you tell me about a time where you encountered a challenge? How did you overcome it?",
                    },
                    {
                      type: "p-bold",
                      text: "How you can respond:",
                    ...
                    },
                    {
                      type: "header",
                      text:
                        "7. What are things you look forward to with this role?",
                    },
                    {
                      type: "p-bold",
                      text: "How you can respond:",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "After practicing the possible interview questions in this activity, you may also proceed to have a mock interview with your designated instructor or practice with your self-advocacy group. This will allow you to go into the interview fully prepared.",
                    },
                    {
                      type: "ref",
              ...
              parts: [
                {
                  ...
                  body: [
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Now that you have moved on from the interview phase, let us hope that your results bear some good news! If so, welcome to the world of employment!",
                    },
                    {
                      type: "p",
                      text:
                        "Now that you have entered the workforce, you have to properly observe certain etiquettes. Although the pandemic has pushed a lot of the work into a work-from-home or online setting, proper decorum must still be maintained. With that said, here are the first few general things to remember on a online setting:",
                    },
                    {
                      type: "header",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "There are differences and consequences between “Reply” and “Reply All” in an email. Sometimes, there are details in the mail attached that are meant to be confidential to other parties that were originally copied into the email thread. With that, it is your responsibility to always check beforehand. ",
                    },
                    {
                      type: "header",
                      text: "2. Disclosure and Assistance",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Even though you may be subjected to work at home with the current crisis the whole world is facing, you must still look presentable whenever there are online company meetings. It helps people to take you seriously, and it also shows that you are taking your job seriously too. ",
                    },
                    {
                      type: "header",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Since the pandemic started, it became hard for many to divide their time between work and relax because everything happens already in the comforts of people’s homes. Because of this, make sure to set times where your co-workers can be sure that they are able to contact you for work-related concerns. By making yourself available, you can improve your collaboration with a remote team. ",
                    },
                    {
                      type: "header",
                    ...
                    },
                    {
                      type: "p",
                      text:
                        "Even as simple as a smile in a work call can make the air in the call lighter. Having a positive attitude will not only make you seem approachable, but it will also affect your job performance significantly. Never underestimate this power!",
                    },
                    {
                      type: "img",
                    ...
                    },
                    {
                      type: "listHeader",
                      text:
                        "As a deaf individual who is part of the PWD community, there is also a different set of etiquettes you must follow in order to have a pleasant working environment:",
                    },
                    {
                      type: "list",
                      text: [
                    ...
                    },
                    {
                      type: "ref",
                      text:
                        "https://www.wright.edu/inclusive-excellence/disability-services/disability-etiquette-in-the-workplace",
                    },
                    {
                      type: "ref",
                      text:
                        "https://money.usnews.com/money/blogs/outside-voices-careers/articles/workplace-etiquette-for-the-office-and-remote",
                    },
                    {
                      type: "ref",
                      text:
                  ...
                  body: [
                    {
                      type: "p",
                      text:
                        "To refresh your memory, state some examples of both general and disability etiquette you must practice and why they are important. Please make sure that you give at least 3 examples and apply it to your everyday life. ",
                    },
                  ],
                  replies: [
                    {
          ...
          discussions: [
            {
              ...
              replies: [
                ...
                },
                {
                  ...
                  time: "17:29",
                  comment:
                    "Here are some of my works that I am proud of during my internship :D",
                  files: [],
                  replies: [],
                },
              ],
      ...
      allCourses: [
        {
          ...
          intro: [
            { type: "header", text: "About this specialization" },
            {
              type: "p",
              text:
                "In this class, you will learn how to speak up for yourself, make your own decisions and find confidence in your skills for future job applications with the help of Project Inclusion. You will also find others who are on the same journey as you are and find those who will support you. It is also important to know your rights and responsibilities as an individual and as a person with disability. ",
            },
            { type: "header", text: "What you will Learn " },
            {
              type: "list",
              text: [
      ...
      allInternships: [
        {
          ...
          intro: [
            { type: "header", text: "What is Booky?" },
            {
              type: "p",
              text:
                "Booky is a homegrown food app where you can discover new restaurants, get unlimited discounts, and claim numerous digital coupons. On top of that, Booky works completely OFFLINE.",
            },
            { type: "header", text: "Booky Internship Opportunity" },
            {
              type: "p",
              text:
                "We're looking for an individual to become a member of the marketing team, working closely with the campaigns and partnerships team, but also coordinating with the different teams in the company (digital marketing, creatives, web team). At the end of this internship, the individual will have a holistic experience of marketing as a discipline while having developed core attributes in managing campaigns, forging relationships with partners, and ideating and executing marketing strategies. ",
            },
            { type: "header", text: "Responsibilities" },
            {
              type: "list",
              text: [
      ...
      inbox: ref([
        ...
        {
          name: "Cha Tan, Edric Carlos",
          readMessages: [
            {
              name: "Edric Carlos",
              time: "11:52",
              message: "Hi Cha! Nice to meet you all :))",
              picture: null,
              file: null,
            },
            {
          ...
          unreadMessages: [
            {
              ...
              time: "17:05",
              message:
                "Wow, that looks great! Let’s make a group with the head so she can also see :D",
              picture: null,
              file: null,
            },
            {
            ...
            },
            {
              ...
              time: "16:31",
              message:
                "So from the call earlier, it looks like we will have to send the resumes we made to the group so we can comment on each other’s works. ",
              picture: null,
              file: null,
            },
          ],
  ...
  mutations: {
    ...
    finishModulePart(state, { id, moduleID, moduleIDID }) {
      ...
      if (moduleIDID < state.myCourses[id].modules[moduleID].parts.length - 1) {
        ...
        state.myCourses[id].modules[moduleID].parts[moduleIDID + 1].status =
          state.myCourses[id].modules[moduleID].parts[moduleIDID + 1].status ==
          2
            ? 2
            : 3;
    ...
    sendMessage(state, { message }) {
      // mutate state
      // var inbox = state.inbox[3];
      state.inbox[3].readMessages = state.inbox[3].unreadMessages.concat(
        state.inbox[3].readMessages
      );
      state.inbox[3].unreadMessages = [];
      state.inbox[3].readMessages.splice(state.inbox[3].readMessages, 0, {
        name: "Praise Lam",
        time: "6:00",
        message: message,
        picture: null,
