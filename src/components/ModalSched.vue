    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content p-4">
        <div class="modal-header border-0 p-2 mb-2 pb-2">
          <span class="modal-title h4" id="exampleModalLongTitle2">
            New Schedule
          </span>
          <button
            type="button"
        ...
        <div class="row m-0 p-0">
          <div class="col-6 m-0 pl-2 pr-2">
            ...
            <datepicker
              ...
              :value="startDate2"
              :class="[
                'p-2 pl-3 form-control bg-white pr-3 border w-100 m-0 regularM test',
              ]"
        ...
        <div class="row m-0 p-1 mt-4">
          <button
            class="btn btn-outline-primary p-2 pl-3 pr-3 boldM mr-2"
            style="border-radius: 14px"
          >
            ADD ATTACHMENT
          </button>
          <button
            class="btn btn-primary p-2 pl-3 pr-3 boldM"
            style="border-radius: 14px"
            @click="addSched"
            data-dismiss="modal"
          >
...
export default {
  props: ["curryear", "currmonth", "currday"],
  components: {
    Datepicker,
  },
  data() {
