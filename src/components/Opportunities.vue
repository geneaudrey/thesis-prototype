<template>
  <div class="Dashboard">
    <div class="row m-0 p-0" style="width: 100%">
      ...
      <div
        class="col-10 pl-4 pt-3 d-flex flex-column"
      ...
      >
        ...
        <h1 class="pt-4 h1 text-textPrimary" v-if="type == null">
          CLASSES AND INTERNSHIPS
        </h1>
        <h1 class="pt-4 h1 text-textPrimary" v-if="type == 'all-courses'">
          ALL COURSES
        </h1>
        <h1 class="pt-4 h1 text-textPrimary" v-if="type == 'all-internships'">
          ALL INTERNSHIPS
        </h1>
        <div
        ...
        >
          <div
            class="col m-2 mb-3 card border-0 bg-primary justify-content-center align-items-center"
            style="border-radius: 20px"
          >
            <img :src="courses" class="icon" style="max-width: 502px" />
            <p class="text-white h1">AVAILABLE CLASSES</p>
            <button
              class="btn btn-light boldL rounded-pill pl-4 pr-4 text-primary mt-3 mb-5"
              @click="open('all-courses')"
            >
              ENROLL NOW
            </button>
          </div>
