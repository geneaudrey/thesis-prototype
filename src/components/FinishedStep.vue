    ...
    <div class="col-10 pl-4 pt-3 d-flex flex-column" style="min-height: 100vh">
      ...
      >
        <div v-if="process == 'applications'">
          <img :src="applicationDone" class="icon" style="max-width: 374px" />
          <p class="h2 mb-4">ALL SET UP!</p>
          <p class="regularM mb-0" style="max-width: 600px">
            You have taken one small step towards your goal. Be proud of it! The
            company will now assess your resume before proceeding to the next
            step.
          </p>
          ...
          <p class="regularDefault">
            ...
            <a
              ...
              @click="
                $router.push(
                  $router.currentRoute._rawValue.path.substring(
                    0,
                    $router.currentRoute._rawValue.path.length -
                      '/complete'.length -
                      1
                  )
                )
        ...
        <div v-if="process == 'assessment'">
          <img :src="assessmentDone" class="icon" style="max-width: 374px" />
          <p class="h2 mb-4">YOU PASSED!</p>
          <p class="regularM mb-0" style="max-width: 600px">
            You just passed the assessment by your chosen company. Congrats!
          </p>
          <p class="regularM mb-0">
            Now all you need to do is schedule an interview with them.
          </p>
        ...
        <div v-if="process == 'interviews'">
          <img :src="interviewDone" class="icon" style="max-width: 374px" />
          <p class="h2 mb-4">ALMOST THERE!</p>
          <p class="regularM mb-0" style="max-width: 600px">
            Great job on the interview! We hope that you were able to prepare
            for the questions. All you need to do now is wait. Please check your
            notifications and the proccess page for this internship from time to
            time for updates about your acceptance.
          </p>
          <button
            class="btn btn-primary boldDefault m-4 p-2"
            @click="$router.push('/dashboard')"
...
<script>
import applicationDone from "../assets/For Gene/Illustrations/ENABLE UPDATED-07.svg";
