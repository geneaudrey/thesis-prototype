                ...
                <div class="row p-0 m-0">
                    <div class="col-flex">
                        <div class="card border-0 dashDP" style="width: 71.23px; height: 71.23px">
                            <img v-if="item.img != null && item.img != ''" :src="require('../assets/For Gene/Icons/'+item.img)" class="img-fluid" alt="Responsive image" style="border-radius:12px" />
                        </div>
                    </div>
                    <div class="col-5 mt-auto mb-auto ml-0 mr-0 pr-0">
                        <p class="mb-0 boldDefault"> <b> {{item.subject}} </b> </p>
